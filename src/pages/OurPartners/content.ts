import {
  ...
  UNIFIED_PAYMENT,
  TINGG,
  DOTPAY_OFFICIAL_LOGO,
  ORANGE_PAY_CITISERVE_LOGO,
  AIRVEND_LOGO,
  E_CASH_LUKEPORT_LOGO,
  KIPPA_PAY_LOGO,
  C_POINT_AGENT_CONNECTIONPOINT_LOGO,
  SHAGO_ALERZO_LOGO_ADAPTATION_LOGO,
