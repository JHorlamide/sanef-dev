...
interface GovernmentTableHeaderProps {
  buttonText: string;
  path: string;
...
const GovernmentTableHeader = ({
  buttonText,
  path,
  governments,
  setSearchTerm
}: GovernmentTableHeaderProps) => {
  ...
  const csvData = governments.map((government) => {
    return {
      id: government._id,
      name: government.name,
      logo: government.logo.imageUrl,
      createdAt: government.createdAt,
      updatedAt: government.updatedAt
    };
  });
  ...
  return (
    <div className="flex justify-between">
      ...
      <div className="flex space-x-2">
        ...
        >
          <CSVLink data={csvData} filename="governments\MDA's.csv">
            Download CSV
          </CSVLink>
        </CustomBtn>
...
export default GovernmentTableHeader;
